...
from src.type import LambdaType, BaseType, ArrowType, RecordType, VariantType
...
class TypedLambdaParser:
    ...
    def __init__(self):
        ...
        self.grammar = [
            ...
            ['term', ('variable term_p', reduce_term)],
            ['term', ('abstraction term_p', reduce_abs_term)],
            ['term', ('LPAR term RPAR term_p', reduce_par_term)],
            ['term', ('let term_p', reduce_term)],
            ['term', ('letrec term_p', reduce_term)],
            ['term', ('record term_p', reduce_term)],
            ['term', ('tagging term_p', reduce_term)],
            ['term', ('case term_p', reduce_term)],
            ...
            ['tagging', ('tagged_term AS type', lambda p: TmTagging(p[0][0], p[0][1], p[0][2], p[2]))],
            ...
            ['type', ('record_type type_p', reduce_type)],
            ['type', ('variant_type type_p', reduce_type)],
