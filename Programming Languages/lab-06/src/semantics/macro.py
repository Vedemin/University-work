...
class SeqMacro(Macro):
    ...
    def expand(self, term: DerivedTerm) -> Term | None:
        ...
        #       tip 1. it's defined in TAPL, p. 119
        #       tip 2. remember to update de Bruijn indexes (term_shift)
        #       tip 3. use '_' for the new variable name    
        match term:
            case TmSequence(_, t1, t2):
                return TmApp(Info.dummy_info(), TmAbs(Info.dummy_info(), '_', BaseType.Unit, t2), t1)
